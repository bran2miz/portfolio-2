...
class Header extends Component {
  titles = ['Student at Code Fellows', 'Graduate of Loyola Marymount University', 'Software Developer', 'Python and JavaScript Tutor'];
  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/bran2miz" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
